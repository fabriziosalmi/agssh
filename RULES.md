...
**v1.6.0** · 57 rules · 9 families · cumulative profiles **Bronze ⊂ Silver ⊂ Gold**.

This is the browsable index. The full normative text — *why · check · fix · tool* for every rule —
is the [rendered standard](standard/AGSSH-STD-001-v1.6.0.pdf); the machine-readable form the runner is
